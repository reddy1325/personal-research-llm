...
The assistant directs research and drafting. The human curates judgment, sources, and ship decisions. This repo is the system: how memory persists across sessions, how a knowledge backend gets built one paper at a time, how voice rules are encoded, how facts get verified before they ship, and how a single ingestion produces threads, reports, decks, and replies from the same source material.
...
Not a Twitter bot. Not a single-purpose tool. Not magic. The X posting workflow is one of many output surfaces and is intentionally not the headline.
